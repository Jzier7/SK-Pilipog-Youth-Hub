<template>
  <div class="q-pa-none">
    <div class="q-mb-md q-gutter-sm flex items-center">
      <q-btn label="Add Team" color="primary" @click="openAddModal" class="q-mr-sm" />
      <q-space />
      <q-input rounded outlined dense color="primary" v-model="search" placeholder="Search by team name"
        class="q-mr-sm">
    ...
    <q-table flat bordered :rows="teams" :columns="columns" row-key="id" :pagination="{ rowsPerPage: pageSize }"
      hide-bottom>
      ...
      <template v-slot:body-cell-actions="props">
        <q-td :props="props" align="center">
          ...
          <q-btn flat dense icon="visibility" color="secondary" @click="openViewModal(props.row)" />
        </q-td>
      </template>
    </q-table>
