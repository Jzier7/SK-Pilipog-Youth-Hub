<template>
  <div class="q-pa-none">
    <div class="q-mb-md q-gutter-sm flex items-center">
      <q-btn label="Add Official" color="primary" @click="openAddModal" class="q-mr-sm" />
      <q-space />
      <q-select v-model="selectedPosition" :options="positionOptions" dense outlined color="primary"
        :clearable="selectedPosition !== null" emit-value map-options use-input input-debounce="0"
        label="Select Position" @filter="filterPositions" option-label="name" option-value="id" />
      <q-select v-model="selectedTerm" :options="termOptions" dense outlined color="primary"
        :clearable="selectedTerm !== null" emit-value map-options use-input input-debounce="0" label="Select Term"
        @filter="filterTerms" option-label="date_range" option-value="id" />
    ...
    <q-table flat bordered :rows="officials" :columns="columns" row-key="id" :pagination="{ rowsPerPage: pageSize }"
      hide-bottom>
