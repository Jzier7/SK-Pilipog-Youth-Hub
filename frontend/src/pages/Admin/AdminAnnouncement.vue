<template>
  <q-page padding>
    ...
    <div class="row justify-between">
      <q-btn dense label="Add Announcement" color="primary" @click="openAddModal"
        style="text-transform: capitalize;"></q-btn>

      <form @submit.prevent="fetchAnnouncements">
        <q-input rounded outlined dense v-model="search" placeholder="Search Announcements" @input="filterAnnouncements"
          color="primary">
    ...
    <div class="q-mt-md">
      ...
      <q-card v-for="announcement in announcements" :key="announcement.id" flat bordered
        ...
        <q-card-actions class="row justify-end">
          <q-btn label="View" color="secondary" @click="openViewModal(announcement)" style="text-transform: capitalize;"
            class="q-mr-md" />
          <q-btn label="Edit" color="primary" @click="openEditModal(announcement)" style="text-transform: capitalize;"
            class="q-mr-md" />
